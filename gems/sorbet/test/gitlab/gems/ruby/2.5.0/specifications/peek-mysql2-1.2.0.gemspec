# -*- encoding: utf-8 -*-
# stub: peek-mysql2 1.2.0 ruby lib

Gem::Specification.new do |s|
  s.name = "peek-mysql2".freeze
  s.version = "1.2.0"
  ...
  s.date = "2017-06-21"
  s.description = "Take a peek into the MySQL queries made during your application's requests.".freeze
  s.email = ["me@garrettbjerkhoel.com".freeze]
  s.homepage = "https://github.com/peek/peek-mysql2".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.7.7".freeze
  s.summary = "Take a peek into the MySQL queries made during your application's requests.".freeze
