...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<character_set>.freeze, ["~> 1.1"])
      s.add_runtime_dependency(%q<regexp_parser>.freeze, ["~> 1.1"])
      s.add_runtime_dependency(%q<regexp_property_values>.freeze, ["~> 0.3"])
      ...
      s.add_dependency(%q<character_set>.freeze, ["~> 1.1"])
      s.add_dependency(%q<regexp_parser>.freeze, ["~> 1.1"])
      s.add_dependency(%q<regexp_property_values>.freeze, ["~> 0.3"])
